...
The SGM is a model used to embed words into vectors, by analyzing the context in which the words happens. The model is trained to predict the words that are next to the input word $w$, by maximizing the following equation:

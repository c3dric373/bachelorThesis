...
$m$ is a hyper parameter of the model. An important thing to notice is that instead of always using the same $m$, each word will randomly have a number $r$ that is in the range $(1,m)$ as it's window size.
